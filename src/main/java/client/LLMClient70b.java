...
public class LLMClient70b {
    ...
    private static final String LLM_MODEL =
            getEnvOrDefault("LLM_MODEL", "llama3.1:8b");
     ...
     * ~1183 tokens.
     *
     * So num_ctx = 2048 should be enough:
     * 1183 prompt tokens + ~96 output tokens + safety buffer.
     */
    private static final int OLLAMA_NUM_CTX = 2048;
    private static final int RESERVED_OUTPUT_TOKENS = 128;
    private static final int NUM_PREDICT = 96;
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("LLM client 70B completed successfully.");
    }
    ...
    private static void printCubeSchemaDebugInfo(CubeSchema cubeSchema) {
        System.out.println("===== LLM CLIENT 70B TEST =====");
        ...
        System.out.println("LLM client 70B schema loading completed successfully.");
    }
    ...
    private static String sendPromptToLLM(String prompt) throws Exception {
        ...
        try {
            ...
            /*
             * 0 = infinite read timeout from Java side.
             * If nginx has 60s timeout, nginx can still return 504.
             */
    ...
    private static String buildJsonPayload(String prompt) {
        ...
        /*
         * For now we keep stream false.
         * If 70B still times out, next step is stream true.
         */
        json.append("\"stream\":false,");

        /*
         * Keep 70B loaded longer.
         * This helps avoid paying load time again and again.
         */
        json.append("\"keep_alive\":\"30m\",");
        ...
        json.append("\"top_k\":10,");
        json.append("\"top_p\":0.8");
        json.append("}");
        json.append("}");
    ...
    private static void printLLMResponseStats(LLMResponseStats stats) {
        ...
        if (stats.getPromptContextUsageRatio() >= WARNING_CONTEXT_USAGE_RATIO) {
            System.out.println("WARNING: Prompt uses more than "
                    ...
                    + " of num_ctx. You are close to the configured context limit.");
        } else {
